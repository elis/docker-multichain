...
This is the repository for the settlemint/*-multichain docker images.
...
Use this [docker-compose.yml](https://github.com/settlemint/docker-multichain/blob/master/docker-compose.yml) and run:
